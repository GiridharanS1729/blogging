            ...
            <div class="contact-container">
                <div class="contact-info">
                    ...
                    <div class="contact-details">
                        <p class="contact-detail">
                            ...
                            <span>Harur, TamilNadu</span>
                        </p>
                        <p class="contact-detail">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon">
                                <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                            </svg>
                            <span>9361609946</span>
                        </p>
                        <p class="contact-detail">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon">
                            ...
                            <span>giridharans1729@gmail.com</span>
                        </p>
                    </div>
                </div>
                <form class="contact-form">
                    <label class="form-label">
                        <span>Full name</span>
                        <input type="text" placeholder="Giridharan S" class="form-input" value={name} onChange={(e) => setName(e.target.value)} />
                    </label>
                    <label class="form-label">
                    ...
                    <label class="form-label">
                        <span>Message</span>
                        <textarea rows="3" class="form-textarea" value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
                    </label>
